...
class OTPVerifyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final defaultPinTheme = PinTheme(
      width: 65, height: 65,
      textStyle: GoogleFonts.outfit(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.black),
          ...
          child: Column(
            ...
            children: [
              ...
              Column(children: [
                ...
                Text('anton@it.pens.student.com', style: GoogleFonts.outfit(fontSize: 16, color: Colors.grey.shade700, fontWeight: FontWeight.w500)),
              ]),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const NewPasswordScreen())),
                  ...
                  child: Text('Verify email', style: GoogleFonts.outfit(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                ),
              ),
              const SizedBox(height: 30),
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                Text("Didn't receive the code? ", style: GoogleFonts.outfit(fontSize: 14, color: Colors.grey)),
                GestureDetector(onTap: () {}, child: Text('Resend again', style: GoogleFonts.outfit(fontSize: 14, color: AppColors.lightTeal, fontWeight: FontWeight.bold))),
              ]),
              const SizedBox(height: 50),
              GestureDetector(

...
class RegisterOTPVerifyScreen extends StatefulWidget {
  final String email;
  const RegisterOTPVerifyScreen({super.key, required this.email});
...
class _RegisterOTPVerifyScreenState extends State<RegisterOTPVerifyScreen> {
  ...
  Future<void> _handleVerifyOTP() async {
    ...
    try {
      final res = await ApiClient().verifyRegisterOTP(widget.email, _otpCode!);
  ...
  Future<void> _handleResendOTP() async {
    ...
    try {
      await ApiClient().resendRegisterOTP(widget.email);
      if (mounted) {
        ScaffoldMessenger.of(context)
          ..clearSnackBars()
          ..showSnackBar(
